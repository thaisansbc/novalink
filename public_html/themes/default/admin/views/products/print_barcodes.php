                                        ...
                                        if ($style == 'shelf') {
                                            ...
                                            <table width="100%">
                                                <tr>
                                                    <td width="33%">';
                                                        if ($item['name']) {
                                                            echo '<span style="font-size: 15px;" class="barcode_name">' . character_limiter($item['name'], 25) . '</span>';
                                                        }
                                                        if ($item['weight']) {
                                                            echo '<span style="font-size: 15px;" class="barcode_name">' . $this->bpas->formatDecimal($item['weight']) . '</span>';
                                                        }
                                                        if ($item['price']) {
                                                            echo '<span class="barcode_price" style="display: block; font-size: 15px; font-weight: bold; text-align: left; margin-bottom: 5%; margin-right: 20px;">';
                                                            if ($item['currencies']) {
                                                                foreach ($currencies as $currency) {
                                                                    echo  $currency->code . ': ' . $this->bpas->formatMoney($item['rprice'] * $currency->rate, 'none') . ', ';
                                                                }
