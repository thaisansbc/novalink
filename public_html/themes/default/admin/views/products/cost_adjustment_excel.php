...
<div class="modal-dialog">
    <div class="modal-content">
        ...
        echo admin_form_open_multipart("products/add_cost_adjustment_excel/", $attrib); ?>
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="well well-small">
                        <a href="<?php echo base_url(); ?>assets/excel/sample_cost_adjustments.xlsx" class="btn btn-primary pull-right">
