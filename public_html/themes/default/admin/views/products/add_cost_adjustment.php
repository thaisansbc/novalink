...
<script type="text/javascript">
    ...
    $(document).ready(function () {
        ...
        $(document).on('change', '#cadate', function (e) {
            localStorage.setItem('cadate', $(this).val());
        });
        if (cadate = localStorage.getItem('cadate')) {
            $('#cadate').val(cadate);
        }
        <?php } ?>
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-plus"></i><?= lang('add_cost_adjustment'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                echo admin_form_open_multipart("products/add_cost_adjustment", $attrib);
                ?>
                <div class="row">
                    <div class="col-lg-12">
                        <?php if ($Owner || $Admin || $GP['products-cost_adjustments-date']) { ?>
                            <div class="col-md-4">
                                <div class="form-group">
                                    <?= lang("date", "cadate"); ?>
                                    <?php echo form_input('date', (isset($_POST['date']) ? $_POST['date'] : ""), 'class="form-control input-tip datetime" id="cadate" required="required"'); ?>
                                </div>
                            </div>
                        <?php } ?>
                        ...
                        <div class="col-md-4 <?= ((!$Owner && !$Admin && !$GP['reference_no']) ? 'hidden' : '') ?>">
                            <div class="form-group">
                                ...
                                <?php echo form_input('reference_no', (isset($_POST['reference_no']) ? $_POST['reference_no'] : ''), 'class="form-control input-tip" id="caref"'); ?>
                            </div>
                        </div>
                                ...
                                <div class="controls table-controls">
                                    <table id="caTable" class="table items table-striped table-bordered table-condensed table-hover">
                                        ...
                                        <tr>
											...
											<th class="col-md-2"><?= lang("old_cost"); ?></th>
                        ...
                        <div class="col-md-12">
                            <div
                                class="fprom-group"><?php echo form_submit('add_cost_adjustment', lang("submit"), 'id="add_cost_adjustment" class="btn btn-primary" style="padding: 6px 15px; margin:15px 0;"'); ?>
...
<script type="text/javascript">
	$(function(){
		...
		function biller(){
			...
			var project = 0;
			$.ajax({
				url : "<?= admin_url("products/get_project") ?>",
				type : "GET",
				dataType : "JSON",
