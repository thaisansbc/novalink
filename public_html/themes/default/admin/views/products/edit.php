                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group all">
                                        <?= lang('serial', 'serial') ?>
                                        <?= form_input('serial', (isset($_POST['serial']) ? $_POST['serial'] : ($product ? $product->serial_no : '')), 'class="form-control" id="serial" ') ?>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="form-group all">
                            ...
                            <div class="col-md-12">
                                ...
                                <div class="form-group all">
                                    ...
                                    <?= form_textarea('product_details', $this->bpas->decode_html($product->product_details), 'class="form-control" '); ?>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group all">
                                        <?= lang('Key points', 'detail') ?>
                                        <?= form_textarea('details', (isset($_POST['details']) ? $_POST['details'] :$this->bpas->decode_html($product->details)), 'class="form-control" '); ?>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group all">
                                        <?= lang('Benefit', 'Benefit') ?>
                                        <?= form_textarea('cf4', (isset($_POST['cf4']) ? $_POST['cf4'] : $this->bpas->decode_html($product->cf4)), 'class="form-control" '); ?>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <div class="form-group all">
                                        <?= lang('Recommended Users', 'Ingredients') ?>

                                        <?= form_textarea('cf5', (isset($_POST['cf5']) ? $_POST['cf5'] : $this->bpas->decode_html($product->cf5)), 'class="form-control" '); ?>
                                    </div>
                                </div>

                                <div class="col-md-6">
                                    <div class="form-group all">
                                        <?= lang('Recommended Usage', 'The Brand') ?>
                                        <?= form_textarea('cf6', (isset($_POST['cf6']) ? $_POST['cf6'] : $this->bpas->decode_html($product->cf6)), 'class="form-control" '); ?>
                                    </div>
                                </div>
    ...
    ?>
        $(document).ready(function() {
            ...
            ?>
                ...
                $('#supplier_price').val("<?= $this->bpas->formatDecimal($product->supplier1price); ?>");
            ...
            ?>
                ...
                $('#supplier_2_price').val("<?= $this->bpas->formatDecimal($product->supplier2price); ?>");
            ...
            ?>
                ...
                $('#supplier_3_price').val("<?= $this->bpas->formatDecimal($product->supplier3price); ?>");
            ...
            ?>
                ...
                $('#supplier_4_price').val("<?= $this->bpas->formatDecimal($product->supplier4price); ?>");
            ...
            ?>
                ...
                $('#supplier_5_price').val("<?= $this->bpas->formatDecimal($product->supplier5price); ?>");
