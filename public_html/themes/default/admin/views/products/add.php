                                ...
                                <div class="col-md-12">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group all">
                                            ...
                                            <?= form_textarea('cf4', (isset($_POST['cf4']) ? $_POST['cf4'] : ($product ? $product->cf4 : '')), 'class="form-control" '); ?>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group all">
                                            ...
                                            <?= form_textarea('cf5', (isset($_POST['cf5']) ? $_POST['cf5'] : ($product ? $product->cf5 : '')), 'class="form-control" '); ?>
                                        </div>
                                    </div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group all">
                                            ...
                                            <?= form_textarea('cf6', (isset($_POST['cf6']) ? $_POST['cf6'] : ($product ? $product->cf6 : '')), 'class="form-control" '); ?>
                                        </div>
                                    </div>
