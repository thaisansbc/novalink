							...
							<table>
								<tr>
									<td class="text_center" style="width:20%">
										<?php
											echo '<img width="120" src="'.base_url().'assets/uploads/logos/' . $biller->logo.'" alt="'.$biller->name.'">';
										?>
									</td>
									...
									<td class="text_center" style="width:20%">
										<?= $this->bpas->qrcode('link', urlencode(site_url('products/view_cost_adjustment/' . $inv->id)), 2); ?>
									</td>
								</tr>
							</table>
						</th>
						...
						<th>
							<table>
								<tr>
									...
									<td class="text_center" style="width:20%"><span style="font-size:<?= $font_size+5 ?>px"><b><i><?= lang('cost_adjustment') ?></i></b></span></td>
										...
										<fieldset>
											...
											<table>
												...
												<?php if($project){ ?>
													<tr>
														<td><?= lang('project') ?></td>
														<td style="text-align:left"> : <b><?= $project->project_name ?></b></td>
													</tr>
												<?php } ?>
											</table>
										</fieldset>
					...
					<?php
						...
						foreach ($rows as $row){
							$tbody .='<tr>
											...
											<td class="text_right">'.$this->bpas->formatMoney($row->old_cost).'</td>
											<td class="text_right">'.$this->bpas->formatMoney($row->new_cost).'</td>
										</tr>';		
							$i++;
						}
					?>
