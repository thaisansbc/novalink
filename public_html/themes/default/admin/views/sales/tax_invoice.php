                    ...
                    <tr>
                        <td>
                            <div class="col-xs-4">
                                ...
                                if ($biller->logo) { ?>
                                    <div>
                                        <img src="<?= base_url() . 'assets/uploads/logos/' . $biller->logo; ?>" alt="<?= $biller->company && $biller->company != '-' ? $biller->company : $biller->name; ?>" width="150"></div>
                                <?php } ?>                                
                            </div>
                            <div class="col-xs-8" style="padding-left: 0;">
                                <div style="font-weight: bold; font-family: 'Khmer OS Muol Light';font-size: 22px;"><?= $biller->cf1; ?></div>
                                <div style="font-weight: bold; font-family: 'FontAwesome';font-size: 20px;"><?=  $biller->company && $biller->company != '-' ? $biller->company : $biller->name; ?></div>
