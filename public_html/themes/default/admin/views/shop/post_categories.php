...
<script>
    $(document).ready(function () {
        ...
        oTable = $('#PgData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('shop_settings/getPostCategories') ?>',
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-money"></i><?= lang('posts'); ?></h2>
            ...
            <ul class="btn-tasks">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?= admin_url('shop_settings/add_post'); ?>">
                                <i class="fa fa-plus"></i> <?= lang('add_post') ?>
                            </a>
                        </li>
                        <li class="divider"></li>
                        <li>
                            <a href="#" id="delete" data-action="delete">
                            <i class="fa fa-trash-o"></i> <?= lang('delete_posts') ?>
                            </a>
                        </li>
                    </ul>
                </li>
