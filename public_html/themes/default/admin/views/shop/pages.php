...
<script>
    $(document).ready(function () {
        ...
        oTable = $('#PgData').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('shop_settings/getPages') ?>',
                    ...
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li>
                            <a href="<?= admin_url('shop_settings/add_page'); ?>">
                                <i class="fa fa-plus"></i> <?= lang('add_page') ?>
                            </a>
                        </li>
                        <li class="divider"></li>
                        <li>
                ...
                <div class="table-responsive">
                    <table id="PgData" class="table table-bordered table-hover table-striped">
                        ...
                        <tr>
                            ...
                            <th class="col-xs-6"><?= lang('description'); ?></th>
                            <th class="col-xs-1"><?= lang('active'); ?></th>
                            <th class="col-xs-1"><?= lang('order'); ?></th>
