...
<script>
    $(document).ready(function () {
        oTable = $('#SaLeDATA').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('reports/getMemberReport/?v=1' . $v) ?>',
            ...
            "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                ...
                for (var i = 0; i < aaData.length; i++) {
                    sale_qty     += parseFloat(aaData[aiDisplay[i]][5]);

             
                }
                var nCells = nRow.getElementsByTagName('th');
                nCells[5].innerHTML = currencyFormat(parseFloat(sale_qty));
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-heart"></i><?= lang('member_report'); ?> <?php
            if ($this->input->post('start_date')) {
    ...
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                ...
                <div id="sform">
                <?php echo admin_form_open('reports/member_report'); ?>
                <div class="row">
                    <div class="col-sm-4">
            ...
            <div class="table-responsive">
                ...
                <thead>
                    <tr>
                        <th style="width: 180px;"><?php echo lang('date'); ?></th>
            
                        <th style="width: 150px;"><?php echo lang('reference_no'); ?></th>
                        <th style="width: 250px;"><?php echo lang('biller'); ?></th>
                        <th><?php echo lang('member'); ?></th>
                        <th><?php echo lang('customer'); ?></th>
                        <th style="width: 150px;"><?php echo lang('total_bv'); ?></th>
                    </tr>
                </thead>
                <tbody>
                    <tr>
