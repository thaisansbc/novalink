        ...
        $(document).ready(function () {
            ...
            "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                ...
                for (var i = 0; i < aaData.length; i++) {
                    rgtotal += parseFloat(aaData[aiDisplay[i]][6]);
                }
                var nCells = nRow.getElementsByTagName('th');
                nCells[6].innerHTML = currencyFormat(parseFloat(rgtotal));
            }
                            ...
                            <div class="table-responsive">
                                ...
                                <thead>
                                    <tr>
                                        ...
                                        <th style="width: 40px;"><?= lang('saleman'); ?></th>
            ...
            $(document).ready(function () {
                oTable = $('#SaLeDATA').dataTable({
                    ...
                    "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                        ...
                        for (var i = 0; i < aaData.length; i++) {
                            sale_qty     += parseFloat(aaData[aiDisplay[i]][6]);
                            award_points += parseFloat(aaData[aiDisplay[i]][8] ? aaData[aiDisplay[i]][8] : 0);
                            commission   += parseFloat(aaData[aiDisplay[i]][9] ? aaData[aiDisplay[i]][9] : 0);
                            gtotal       += parseFloat(aaData[aiDisplay[i]][10]);
                            paid         += parseFloat(aaData[aiDisplay[i]][11]);
                            balance      += parseFloat(aaData[aiDisplay[i]][12]);
                        }
                        var nCells = nRow.getElementsByTagName('th');
                        nCells[6].innerHTML = currencyFormat(parseFloat(sale_qty));
                        nCells[8].innerHTML = currencyFormat(parseFloat(award_points));
                        nCells[9].innerHTML = currencyFormat(parseFloat(commission));
