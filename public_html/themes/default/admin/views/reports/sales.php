...
<script>
    $(document).ready(function () {
        oTable = $('#SlRData').dataTable({
            ...
            "aoColumns": [
                {"mRender": fld}, null, null, null, null, null, {"mRender": formatQuantity}, 
            ...
            "fnFooterCallback": function (nRow, aaData, iStart, iEnd, aiDisplay) {
                ...
                for (var i = 0; i < aaData.length; i++) {
                    ...
                    if(aaData[aiDisplay[i]][6] != null){
                        customer_total += parseFloat(aaData[aiDisplay[i]][6]);
                    }
                }
                var nCells = nRow.getElementsByTagName('th');
                nCells[6].innerHTML = currencyFormat(parseFloat(customer_total));
            ...
            {column_number:6, filter_default_label: "[<?=lang('customer').' (QTY)';?>]", filter_type: "text", data: []},
