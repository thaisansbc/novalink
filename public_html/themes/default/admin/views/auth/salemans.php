    ...
    $(document).ready(function () {
        function saleman_status(x) {
            ...
            return y[0] == 1 ?
                ...
                '<a href="' +
                site.base_url +
                'auth/activate_saleman/' +
                y[1] +
                '" data-toggle="modal" data-target="#myModal"><span class="label label-danger"><i class="fa fa-times"></i> ' +
                lang['inactive'] +
                '</span><a/>';
        }
        'use strict';
        oTable = $('#UsrTable').dataTable({
            ...
            'sAjaxSource': '<?= admin_url('auth/getSalemans') ?>',
            ...
            "aoColumns": [{
                "bSortable": false,
                "mRender": checkbox
            }, null, null, null, null, null, null, {"mRender": saleman_status},{"bSortable": false}]
...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-users"></i><?= lang('salemans'); ?></h2>
        <div class="box-icon">
            <ul class="btn-tasks">
                <li class="dropdown">
                    <a data-toggle="dropdown" class="dropdown-toggle" href="#"><i class="icon fa fa-tasks tip" data-placement="left" title="<?= lang('actions') ?>"></i></a>
                    <ul class="dropdown-menu pull-right tasks-menus" role="menu" aria-labelledby="dLabel">
                        <li><a href="<?= admin_url('auth/create_member'); ?>"><i class="fa fa-plus-circle"></i> <?= lang('create_member'); ?></a></li>
                ...
                <div class="table-responsive">
                    <table id="UsrTable" cellpadding="0" cellspacing="0" border="0"
                        ...
                        <tr>
                            ...
                            <th class="col-xs-2"><?php echo lang('sponor'); ?></th>
                            <th class="col-xs-1"><?php echo lang('rank'); ?></th>
