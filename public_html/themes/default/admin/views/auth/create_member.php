...
<div class="box">
    <div class="box-header">
        <h2 class="blue"><i class="fa-fw fa fa-users"></i><?= lang('create_member'); ?></h2>
    </div>
    <div class="box-content">
        <div class="row">
            <div class="col-lg-12">
                <p class="introtext"><?php echo lang('create_member'); ?></p>
                <?php $attrib = ['class' => 'form-horizontal', 'data-toggle' => 'validator', 'role' => 'form'];
                echo admin_form_open('auth/create_member', $attrib);
                ?>
                <div class="row">
                    <div class="col-md-12">
                        <div class="col-md-5">
                        ...
                        <div class="col-md-5 col-md-offset-1">
                            ...
                            <div class="no">
                                ...
                                <div class="form-group">
                                    ...
                                    echo form_dropdown('node', $node, (isset($_POST['node']) ? $_POST['node'] : 0), 'id="node" class="form-control select" style="width:100%;"');
                                    ?>
                                </div>

                                 <div class="form-group">
                                    <?= lang('position_member', 'position_member'); ?>
                                    <?php
                                    $position = [
                                        '' => 'Please select position_member',
                                        'left' => lang('left'),
                                        'right' => lang('right')
                                    ];
                                    echo form_dropdown('position_member', $position, (isset($_POST['position_member']) ? $_POST['position_member'] : ''), 'id="position_member" class="form-control select" style="width:100%;"');
                                    ?>
                                </div>
                ...
                <p><?php echo form_submit('add_user', lang('create_member'), 'class="btn btn-primary"'); ?></p>
                <?php echo form_close(); ?>
            </div>
        </div>
    </div>
