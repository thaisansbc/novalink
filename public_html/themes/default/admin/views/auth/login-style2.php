...
<head>
    ...
    <link rel="apple-touch-icon" sizes="180x180" href="<?= base_url(); ?>favicon_180.ico">
    <link rel="icon" type="image/png" sizes="32x32" href="<?= base_url(); ?>favicon_32.ico">
    <link href="<?= $assets ?>styles/theme.css" rel="stylesheet"/>
    <link href="<?= $assets ?>styles/style_d.css" rel="stylesheet"/>
...
<body class="login-page">
                ...
                <div id="login">
                    <div class="container"> 
                        <div class="login-form-div">
                                ...
                                <div class="col-sm-12">
                                    <div class="textbox-wrap form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="text" value="<?= DEMO ? 'sbcsolutions' : ''; ?>" required="required" class="form-control" name="identity"
                                    ...
                                    <div class="textbox-wrap form-group">
                                        <div class="input-group">
                                            ...
                                            <input type="password" value="<?= DEMO ? 'Sbc@12345' : ''; ?>" required="required" class="form-control " name="password"
                                            placeholder="<?= lang('pw') ?>"/>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="login-form-links_ link2">
                            ...
                            if ($Settings->allow_reg) {
                                ?>
                                <div class="login-form-links_ link1">
    ...
    <div class="footer">
        ©2017 - 2023 All Right Reserved by SMARTBTOC Solutions Co.,Ltd.
    </div>
