                            ...
                            <li class="mm_products">
                                ...
                                <ul>
                                    ...
                                    <li id="products_cost_adjustments">
                                        <a class="submenu" href="<?= admin_url('products/cost_adjustments'); ?>">
                                            <i class="fa-regular fa fa-filter"></i><span class="text"> <?= lang('cost_adjustments'); ?></span>
                                        </a>
                                    </li>
                        ...
                        if ((($this->Settings->ui == 'full')? ($session_module =='sales' && $Settings->module_sale) : $Settings->module_sale) && ($Owner || $Admin ||$GP['sales_order-index']||$GP['sales-index'] || $GP['sales-add'] || $GP['sales-deliveries'] || $GP['sales-gift_cards'] || $GP['sales-view_sale_declare'])) { 
                            ...
                            <li class="mm_sales <?= strtolower($this->router->fetch_method()) == 'sales' ? 'mm_pos' : '' ?>">
                                ...
                                <ul>
                                    ...
                                    <?php } if ($this->config->item('customer_stocks') && ($Owner || $Admin || $GP['sales-customer_stocks'])) { ?>
                    ...
                    <?php } if($this->Settings->module_clearance && ($Owner || $Admin || $GP['reports-sales'] || $GP['clearances-sale_statement_report'] || $GP['clearances-containers'] || $GP['sales-index'] || $GP['clearances-expense_payment_report'] || $GP['clearances-income_by_booking_report'] || $GP['clearances-clearance_report'] || $GP['clearances-expense_by_booking_report'] || $GP['clearances-dry_ports'] || $GP['clearances-trucking_report'] || $GP['clearances-expense_payments'] || $GP['clearances-plan_report'] || $GP['clearances-booking_report'] || $GP['clearances-truckings'] || $GP['clearances-bookings'] || $GP['clearances-countries'] || $GP['clearances-ports'] || $GP['clearances-index'] || $GP['clearances-lines'])){ ?>
                            ...
                            ($this->Settings->ui == 'full')? ($Settings->module_hr && $session_module =='hr') : $Settings->module_hr
                             ...
                             && ($Owner || $Admin || $GP['hr-salary_reviews_report'] || $GP['hr-salary_reviews'] || $GP['hr-kpi_add'] || $GP['hr-id_cards'] || $GP['hr-id_cards_report'] || $GP['hr-sample_id_cards'] || $GP['hr-id_cards'] || $GP['hr-kpi_report'] || $GP['hr-employees_report'] || $GP['hr-banks_report'] || $GP['hr-kpi_index'] || $GP['hr-kpi_types'] || $GP['hr-index'] || $GP['hr-departments'] || $GP['hr-positions'] || $GP['hr-groups'] || $GP['hr-employee_types'] || $GP['hr-employees_relationships'] || $GP['hr-tax_conditions'] || $GP['hr-leave_categories'] || $GP['hr-leave_types'])) { ?>
                                ...
                                <li class="mm_hr hide">
                                    <a class="dropmenu" href="#">
                                        <i class="fa-regular fa fa-users"></i>
                                        <span class="text"> <?= lang('recruitment'); ?> </span> 
                                        <span class="chevron closed"></span>
                                    </a>
                                    <ul> 
                                        <?php if($Owner || $Admin || $GP['hr-candidate']){ ?>
                                            <li id="hr_candidate">
                                                <a class="submenu" href="<?= admin_url('hr/candidate'); ?>">
                                                    <i class="fa-regular fa fa-users"></i><span class="text"> <?= lang('candidate'); ?></span>
                                                </a>
                                            </li>
                                        <?php }if($Owner || $Admin || $GP['hr-shortlist']) { ?>
                                            <li id="hr_shortlist">
                                                <a class="submenu" href="<?= admin_url('hr/shortlist'); ?>">
                                                    <i class="fa-regular fa fa-users"></i><span class="text"> <?= lang('shortlist'); ?></span>
                                                </a>
                                            </li>
                                        <?php } if($Owner || $Admin || $GP['hr-interview']) { ?>
                                            <li id="hr_interview">
                                                <a class="submenu" href="<?= admin_url('hr/interview'); ?>">
                                                    <i class="fa-regular fa fa-users"></i><span class="text"> <?= lang('interview'); ?></span>
                                                </a>
                                            </li>
                                        <?php }?>
                                    </ul>
                        ...
                        if(
                            ...
                            <li class="mm_attendances">
                                ...
                                <?php } if($Owner || $Admin || $GP['attendances-policies']){ ?>
                                    <li id="attendances_roster" class="hide">
                        ...
                        <?php if ($Owner || $Admin || $GP['customers-index']||$GP['customers-add'] || $GP['auth-saleman'] || $GP['suppliers-index']||$GP['suppliers-add'] || $GP['users-index']||$GP['users-add']||$GP['drivers-index']||$GP['drivers-add']) { ?>
                            <li class="mm_auth mm_suppliers">
                                ...
                                <ul>
                                    <li id="auth_users">
                                        <a class="submenu" href="<?= admin_url('auth/binary_model'); ?>">
                                            <i class="fa-regular fa fa-users"></i><span class="text"> <?= lang('binary_model'); ?></span>
                                        </a>
                                    </li>
                                    ...
                                    <li id="auth_users">
                                        <a class="submenu" href="<?= admin_url('system_settings/matching_bonus'); ?>">
                                            <i class="fa-regular fa fa-users"></i><span class="text"> <?= lang('matching_bonus'); ?></span>
                                        </a>
                                    </li>
                                    <li id="auth_users">
                                        <a class="submenu" href="<?= admin_url('system_settings/ranks'); ?>">
                                            <i class="fa-regular fa fa-users"></i><span class="text"> <?= lang('ranks'); ?></span>
                                        </a>
                                    </li>
                                    <li id="auth_approve_ranking">
                                        <a class="submenu" href="<?= admin_url('auth/approve_ranking'); ?>">
                                            <i class="fa-regular fa fa-users"></i><span class="text"> <?= lang('approve_ranking'); ?></span>
                                        </a>
                                    </li>
                                    <li id="auth_users">
                                        <a class="submenu" href="<?= admin_url('system_settings/levels'); ?>">
                                            <i class="fa-regular fa fa-users"></i><span class="text"> <?= lang('levels'); ?></span>
                                        </a>
                                    </li>
                                     <li id="auth_users" class="hide">
                                        <a class="submenu" href="<?= admin_url('auth/members'); ?>">
                                            <i class="fa-regular fa fa-users"></i><span class="text"> <?= lang('members'); ?></span>
                                        </a>
                                    </li>
                                    <li id="auth_users">
                                        <a class="submenu" href="<?= admin_url('auth/sponsor'); ?>">
                                            <i class="fa-regular fa fa-users"></i><span class="text"> <?= lang('sponsor'); ?></span>
                                        </a>
                                    </li>
                                ...
                                <ul class="sub-menu">
                                    ...
                                    <li class="sub_mm_reports_people">
                                        ...
                                        <ul class="sub-sub-menu">
                                            ...
                                            <li id="reports_saleman_bv">
                                                <a href="<?= admin_url('reports/saleman_bv_report') ?>">
                                                    <i class="fa-regular fa fa-users"></i><span class="text"> <?= lang('saleman_bv_report'); ?></span>
                                                </a>
                                            </li>
                                            <?php } ?>
                                            ...
                                            <li id="reports_member_report">
                                                <a href="<?= admin_url('reports/member_report') ?>">
                                                    <i class="fa-regular fa fa-users"></i><span class="text"> <?= lang('member_report'); ?></span>
                                                </a>
                                            </li>
                                        </ul>
                                    </li> 
                        ...
                        if ((SHOP) && ($Owner && file_exists(APPPATH . 'controllers' . DIRECTORY_SEPARATOR . 'shop' . DIRECTORY_SEPARATOR . 'Shop.php'))) { ?>
                            <li class="mm_shop_settings">
                                ...
                                <ul>
                                    ...
                                    <li id="shop_settings_posts">
                                        <a href="<?= admin_url('shop_settings/posts') ?>">
                                            <i class="fa-regular fa fa-file"></i><span class="text"> <?= lang('posts'); ?></span>
                                        </a>
                                    </li>
