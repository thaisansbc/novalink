...
$(document).ready(function() {
    ...
    $('textarea')
        ...
        .redactor({
            buttons: [
                'formatting',
                'format', 'bold', 'italic', 'underline', 'deleted', //Text Formatting
                '|',
                'alignleft',
                'aligncenter',
                'alignright',
                ...
                '|',
                'html',
                'unorderedlist', 'orderedlist', 'indent', 'outdent', 'alignment' //Lists & Alignment:
            ],
            imageUpload: '/assets/upload', // Server endpoint
            imageUploadParam: 'image', // Parameter name
            imageUploadFields: {
...
$(document).ready(function () {
    ...
    $('body').on('click', '.cost_adjustment_link', function() {
