...
$route['e_menu']                    = 'main/e_menu';
$route['membership/(:any)']         = 'main/membership/$1';

// Page route
$route['page/(:any)']               = 'shop/shop/page/$1';
$route['post/(:any)']               = 'shop/shop/post/$1';
...
$route['admin/modules']                     = 'admin/system_settings/modules';
$route['admin']                             = 'admin/welcome';
$route['admin/users']                       = 'admin/auth/users';
$route['admin/users/(:num)']                = 'admin/auth/users/$1';
...
$route['admin/sales_order/(:num)']          = 'admin/sales_order/index/$1';
$route['admin/sales_store/(:num)']          = 'admin/sales_store/index/$1';
$route['admin/sales_order_store/(:num)']    = 'admin/sales_order_store/index/$1';
...
$route['admin/purchases_request/(:num)']    = 'admin/purchases_request/index/$1';
$route['admin/quotes/(:num)']               = 'admin/quotes/index/$1';
$route['admin/transfers/(:num)']            = 'admin/transfers/index/$1';